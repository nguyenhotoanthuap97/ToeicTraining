...
function parseQues(list) {
    ...
    for (var i = 0; i < list.part5.length; i++) {
        text += '<div id = "' + count + '" class = "Quiz_header"></div> <div class = "Quiz_question" onclick = "check(' + count + ')" ><div class = "Quiz_question_text" ><p >' + count + '.' + list.part5[i].noidung + '</p> </div> <ul class = "Quiz_questionList"><li class = "Quiz_questionListItem" data - pos = "0"><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "A" > A.' + list.part5[i].ndA + '</label></li><li class = "Quiz_questionListItem" data - pos = "1" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "B" > B.' + list.part5[i].ndB + '</label></li><li class = "Quiz_questionListItem" data - pos = "2" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "C" > C.' + list.part5[i].ndC + ' </label></li><li class = "Quiz_questionListItem" data - pos = "3" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "D" > D.' + list.part5[i].ndD + ' </label></li></ul > </div>';
        count++;
    }
    ...
    for (var i = 0; i < list.part6.length; i++) {
        ...
        for (var j = 0; j < list.part6[i].listQues.length; j++) {
            text += '<div id = "' + count + '" class = "Quiz_header"></div> <div class = "Quiz_question" onclick = "check(' + count + ')" ><div class = "Quiz_question_text" ><p >' + count + '.' + list.part6[i].listQues[j].noidung + '</p> </div> <ul class = "Quiz_questionList"><li class = "Quiz_questionListItem" data - pos = "0"><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "A" > A.' + list.part6[i].listQues[j].ndA + '</label></li><li class = "Quiz_questionListItem" data - pos = "1" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "B" > B.' + list.part6[i].listQues[j].ndB + '</label></li><li class = "Quiz_questionListItem" data - pos = "2" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "C" > C.' + list.part6[i].listQues[j].ndC + ' </label></li><li class = "Quiz_questionListItem" data - pos = "3" ><label><input class = "Quiz_questionInput" type = "radio" name = "' + count + '" value = "D" > D.' + list.part6[i].listQues[j].ndD + ' </label></li></ul > </div>';
            count++;
        }
    }
